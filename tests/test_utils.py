...
def test_build_violation_identifier() -> None:
    assert (
        build_violation_identifier("rep1", "hashA", "polX")
        == "rep1-hashA-polX"
    )
...
def test_normalize_severity(value, expected) -> None:
    assert normalize_severity(value) == expected


@pytest.mark.parametrize(
    "score,expected",
    [(9.8, "critical"), (7.5, "severe"), (5.0, "moderate"), (1.2, "low"), (0, "none"), (None, "none")],
)
def test_severity_from_cvss(score, expected) -> None:
...
def test_pick_remediation_versions() -> None:
    version_changes = [
        {"type": "next-non-failing", "data": {"component": {"componentIdentifier": {"coordinates": {"version": "1.5.0"}}}}},
        {"type": "next-no-violations", "data": {"component": {"componentIdentifier": {"coordinates": {"version": "2.0.0"}}}}},
    ]
