    ...
    "components": [
        {
            ...
            "violations": [
                {"policyId": "p1", "policyName": "Security-Critical", "policyThreatLevel": 9},
                {"policyId": "p2", "policyName": "Security-Severe", "policyThreatLevel": 5},
            ],
        },
        {
            "hash": "hashB",
...
def test_build_report_entity_counts(client) -> None:  # type: ignore[no-untyped-def]
    ...
    assert report["__url"] == "https://iq.example.com/ui/links/application/my-app/report/rid1"
